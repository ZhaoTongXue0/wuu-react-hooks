...
export async function getRoutes() {
  const routes = {"404":{"id":"404","path":"*","parentId":"DocLayout"},"dumi-context-layout":{"id":"dumi-context-layout","path":"/","isLayout":true},"DocLayout":{"id":"DocLayout","path":"/","parentId":"dumi-context-layout","isLayout":true},"docs/guide/index":{"path":"guide","id":"docs/guide/index","parentId":"DocLayout"},"docs/guide/intro":{"path":"guide/intro","id":"docs/guide/intro","parentId":"DocLayout"},"docs/index":{"path":"","id":"docs/index","parentId":"DocLayout"},"hooks/index":{"id":"hooks/index","path":"hooks","parentId":"DocLayout","meta":{"_atom_route":true}},"hooks/useToggle/index":{"id":"hooks/useToggle/index","path":"hooks/use-toggle","parentId":"DocLayout","meta":{"_atom_route":true}},"demo-render":{"id":"demo-render","path":"~demos/:id","parentId":"dumi-context-layout","prerender":false}} as const;
  return {
    routes,
    routeComponents: {
...
'dumi-context-layout': React.lazy(() => import(/* webpackChunkName: "dumi__tmp-production__dumi__theme__ContextWrapper" */'/Users/zhaoqianyu/Documents/project/前端业务hooks库/wuu-react-hooks/.dumi/tmp-production/dumi/theme/ContextWrapper')),
